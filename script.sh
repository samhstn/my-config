...
curl -SLs "$RAW_GH_URL/sams-aliases.plugin.zsh" > ~/.oh-my-zsh/plugins/sams-aliases/sams-aliases.plugin.zsh
curl -SLs "$RAW_GH_URL/sams-theme.zsh-theme" > ~/.oh-my-zsh/themes/sams-theme.zsh-theme
curl -SLs "$RAW_GH_URL/.vimrc" > ~/.vimrc
